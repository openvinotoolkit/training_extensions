...
import otx.algorithms.action.adapters.mmaction as mmaction
...
class DetectionInferenceTask(BaseTask, IInferenceTask, IExportTask, IEvaluationTask, IUnload):
    ...
    def _infer_detector(
        ...
        batch_size = 1
        mm_test_dataloader = build_dataloader(mm_test_dataset,
        ...
        if torch.cuda.is_available():
            eval_model = MMDataParallel(self._model.cuda(test_config.gpu_ids[0]),
