...
$PYTHON_NAME -m venv "${venv_dir}" --prompt="otx-action"
...
# torch version of mmaction2 is 1.10.2
export TORCH_VERSION=1.8.2
export TORCHVISION_VERSION=0.9.2
# MMCV version of mmaction2 is 1.3.18
...
pip install --no-cache-dir -r ../../../requirements/action.txt
