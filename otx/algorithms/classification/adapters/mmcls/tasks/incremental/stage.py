"""Stage for Incremental learning for OTX Classification with MMCLS."""
...
class IncrClsStage(ClsStage):
    ...
    def configure_task(self, cfg, training):
        ...
        if "task_adapt" in cfg:
            self.configure_task_adapt(cfg, training)

    # noqa: C901
    def configure_task_adapt(self, cfg, training):
