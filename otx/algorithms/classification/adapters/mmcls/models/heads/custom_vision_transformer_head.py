...
class CustomVisionTransformerClsHead(ClsHead):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(CustomVisionTransformerClsHead, self).__init__(init_cfg=init_cfg, *args, **kwargs)
    ...
    def init_weights(self):
        super(CustomVisionTransformerClsHead, self).init_weights()
