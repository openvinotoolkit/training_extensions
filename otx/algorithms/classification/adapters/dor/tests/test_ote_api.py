...
from otx.algorithms.classification.adapters.dor.torchreid_tasks.train_task import OTEClassificationTrainingTask
from otx.algorithms.classification.adapters.dor.torchreid_tasks.utils import generate_label_schema
