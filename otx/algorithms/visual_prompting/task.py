...
from otx.algorithms.visual_prompting.configs.base import VisualPromptingConfig
...
class OTXVisualPromptingTask(OTXTask, ABC):
    """Task class for OTX visual prompting."""

    def __init__(self, task_environment: TaskEnvironment, output_path: Optional[str] = None):
        super().__init__(task_environment, output_path)
        self._task_config = VisualPromptingConfig
    ...
    def infer(
        ...
        """Main infer function for OTX Visual Prompting Task."""
        logger.info("infer()")
    ...
    def train(
        ...
        """Train function for OTX Visual Prompting Task.
    ...
    def export(
        ...
        """Export function of OTX Visual Prompting Task."""
        ...
        #     ir_extra_data = get_vp_inferencer_configuration(self._task_environment.label_schema, self._hyperparams)
    ...
    def explain(
        ...
        """Main explain function of OTX Visual Prompting Task."""
        raise NotImplementedError()
    ...
    def evaluate(
        ...
        """Evaluate function of OTX Visual Prompting Task."""
    ...
    def _add_predictions_to_dataset(self, prediction_results, dataset):
        """Loop over dataset again to assign predictions. Convert from Pytorch lightning format to OTX format."""
    ...
    def save_model(self, output_model: ModelEntity):
        """Save best model weights in VisualPromptingTrainTask."""
