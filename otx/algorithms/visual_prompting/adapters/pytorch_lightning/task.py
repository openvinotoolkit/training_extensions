"""Task of OTX Visual prompting using pytorch lightning training backend."""
...
from otx.algorithms.visual_prompting.task import OTXVisualPromptingTask
...
class PytorchLightningVisualPromptingTask(OTXVisualPromptingTask):
    """Task class for OTX visual prompting using pytorch lightning training backend."""
