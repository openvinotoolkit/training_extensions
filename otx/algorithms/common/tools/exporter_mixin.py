"""Exporter mixin module for OTX export task."""
...
class ExporterMixin:
    """Expoter Mixin class for OTX export."""
    ...
    def mmdeploy_export(
        ...
        """Export model using mmdeploy backend."""
    ...
    def naive_export(output_dir, model_builder, precision, cfg, model_name="model"):
        """Export model using torch backend directly."""
        raise NotImplementedError()
