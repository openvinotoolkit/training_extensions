...
from otx.algorithms.segmentation.adapters.mmseg.tasks.inference_task import OTXSegmentationInferenceTask
...
from otx.algorithms.segmentation.adapters.mmseg.utils.ote_utils import OptimizationProgressCallback
