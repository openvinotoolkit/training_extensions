...
def parse_args():
    ...
    parser.add_argument("--model", help="Input OTX model config file (e.g model.py).")
    parser.add_argument("--backbone", help="Input backbone config file (e.g backbone.yaml).")
    parser.add_argument("--task", help="Input task type (e.g detection).", default=".")
    parser.add_argument("--data", help="Input data.yaml path.", default=".")
