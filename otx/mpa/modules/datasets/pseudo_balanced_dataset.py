...
import numpy as np
from mmdet.datasets import DATASETS, ClassBalancedDataset, build_dataset
...
class PseudoBalancedDataset(ClassBalancedDataset):
    ...
    def __init__(self, pseudo_length=0, oversample_thr=0.001, filter_empty_gt=True, **kwargs):
        # Original dataset
        ...
        super().__init__(dataset=dataset, oversample_thr=oversample_thr, filter_empty_gt=filter_empty_gt)
