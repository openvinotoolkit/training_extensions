...
class TestOTXv1Helper:
    ...
    def test_load_cls_effnet_b0_ckpt(self, label_type: str, fxt_random_tensor:torch.Tensor):
        src_state_dict = {
        ...
        converted_state_dict = OTXv1Helper.load_cls_effnet_b0_ckpt(src_state_dict, label_type, add_prefix="model.model.")
    ...
    def test_load_cls_effnet_v2_ckpt(self, label_type: str, fxt_random_tensor:torch.Tensor):
        ...
        converted_state_dict = OTXv1Helper.load_cls_effnet_v2_ckpt(src_state_dict, label_type, add_prefix="model.model.")
        self._check_ckpt_pairs(converted_state_dict, dst_state_dict)
    
    @pytest.mark.parametrize("label_type", ["multiclass", "multilabel", "hlabel"])    
    def test_load_cls_mobilenet_v3_ckpt(self, label_type: str, fxt_random_tensor:torch.Tensor):
        src_state_dict = {
            "model.weights": fxt_random_tensor,
        ...
        converted_state_dict = OTXv1Helper.load_cls_mobilenet_v3_ckpt(src_state_dict, label_type, add_prefix="model.model.")
        self._check_ckpt_pairs(converted_state_dict, dst_state_dict)
    
    def test_load_det_ckpt(self, fxt_random_tensor:torch.Tensor):
        src_state_dict = {
            "model.weights": fxt_random_tensor,
    ...
    def test_load_iseg_ckpt(self, fxt_random_tensor:torch.Tensor):
        src_state_dict = {
            "model.weights": fxt_random_tensor,
            "head.weights": fxt_random_tensor,
            "ema_model.weights": fxt_random_tensor,
    ...
    def test_load_seg_segnext_ckpt(self, fxt_random_tensor:torch.Tensor):
        src_state_dict = {
            "model.weights": fxt_random_tensor,
            "head.weights": fxt_random_tensor,
    ...
    def test_load_seg_lite_hrnet_ckpt(self, fxt_random_tensor:torch.Tensor):
        src_state_dict = {
            "model.weights": fxt_random_tensor,
            "head.weights": fxt_random_tensor,
    ...
    def test_load_action_ckpt(self, fxt_random_tensor:torch.Tensor):
        src_state_dict = {
            "model.weights": fxt_random_tensor,
            "head.weights": fxt_random_tensor,
        }
