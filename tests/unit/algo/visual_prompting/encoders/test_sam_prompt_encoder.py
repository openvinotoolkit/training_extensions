...
from otx.algo.visual_prompting.encoders.sam_prompt_encoder import (
...
class TestSAMPromptEncoder:
    ...
    def test_get_dense_pe(self):
        ...
        assert results.shape == torch.Size((1, self.image_embedding_size, self.image_embedding_size, self.image_embedding_size))
    ...
    def test_embed_points(self, points: torch.Tensor, labels: torch.Tensor, pad: bool, expected: torch.Size):
        """Test _embed_points."""
    ...
    def test_embed_boxes(self, boxes: torch.Tensor, expected: torch.Size):
        """Test _embed_boxes."""
    ...
    def test_embed_masks(self, mask: torch.Tensor, expected: torch.Size):
        """Test _embed_masks."""
