...
import torch
from otx.algo.visual_prompting.zero_shot_segment_anything import PromptGetter, ZeroShotSegmentAnything, OTXZeroShotSegmentAnything
...
class TestZeroShotSegmentAnything:
    ...
    def test_infer(self, mocker, build_zero_shot_segment_anything) -> None:
        ...
        def _patch_predict_masks(**kwargs):
