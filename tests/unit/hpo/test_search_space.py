...
class TestSearchSpace:
    @staticmethod
    def get_search_space_depending_on_type(types):
    ...
    @staticmethod
    def add_qloguniform_search_space(search_space):
