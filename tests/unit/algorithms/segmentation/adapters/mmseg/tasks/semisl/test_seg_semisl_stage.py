...
from otx.algorithms.segmentation.adapters.mmseg.tasks.semisl.stage import SemiSLSegStage
...
class TestOTXSegStage:
    ...
    def test_configure_task(self, mocker):
        ...
        mock_remove_hook = mocker.patch(
            "otx.algorithms.segmentation.adapters.mmseg.tasks.semisl.stage.remove_custom_hook"
        )
