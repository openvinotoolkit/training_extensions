...
class MockNNCFTask(SegmentationNNCFTask):
    def __init__(self):
        pass
...
class TestNNCFTaskInputParamsValidation:
    ...
    def test_nncf_segmentation_task_init_params_validation(self):
        """
        <b>Description:</b>
        Check SegmentationNNCFTask object initialization parameters validation

        <b>Input data:</b>
        SegmentationNNCFTask object initialization parameter with unexpected type

        <b>Expected results:</b>
        Test passes if ValueError exception is raised when unexpected type object is specified as
        SegmentationNNCFTask object initialization parameter
        """
        with pytest.raises(ValueError):
            SegmentationNNCFTask(task_environment="unexpected string")  # type: ignore

    @e2e_pytest_unit
    def test_nncf_segmentation_task_optimize_params_validation(self):
        """
        <b>Description:</b>
        Check SegmentationNNCFTask object "optimize" method input parameters validation

        <b>Input data:</b>
        SegmentationNNCFTask object. "optimize" method unexpected-type input parameters
    ...
    def test_nncf_segmentation_task_export_params_validation(self):
        """
        <b>Description:</b>
        Check SegmentationNNCFTask object "export" method input parameters validation

        <b>Input data:</b>
        SegmentationNNCFTask object. "export" method unexpected-type input parameters
    ...
    def test_nncf_segmentation_task_save_model_params_validation(self):
        """
        <b>Description:</b>
        Check SegmentationNNCFTask object "save_model" method input parameters validation

        <b>Input data:</b>
        SegmentationNNCFTask object, "output_model" non-ModelEntity object
