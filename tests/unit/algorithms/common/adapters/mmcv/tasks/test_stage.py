...
from otx.algorithms.common.adapters.mmcv.tasks.stage import Stage, get_available_types
...
class TestStage:
    ...
    def test_configure_data(self):
        ...
        fake_cfg = {"work_dir": "test_init_distributed"}
        fake_common_cfg = {"output_path": "/tmp/output"}
        stage = Stage("mpa_test", "", fake_cfg, fake_common_cfg, 0)
    ...
    def test_configure_samples_per_gpu(self, mocker):
        ...
        mocker.patch(
            "otx.algorithms.common.adapters.mmcv.tasks.stage.get_data_cfg",
            return_value=mmcv.ConfigDict(otx_dataset=mock_otx_dataset),
        )
    ...
    def test_configure_unlabeled_dataloader(self, mocker):
        ...
        mock_build_ul_dataset = mocker.patch("otx.algorithms.common.adapters.mmcv.tasks.stage.build_dataset")
        mock_build_ul_dataloader = mocker.patch("otx.algorithms.common.adapters.mmcv.tasks.stage.build_dataloader")
