...
from otx.algorithms.common.utils import distance_utils
from otx.algorithms.common.utils.distance_utils import append_dist_rank_suffix
from tests.test_suite.e2e_test_system import e2e_pytest_unit


@e2e_pytest_unit
def test_append_dist_rank_suffix_not_distributed_training(mocker):
    mock_os = mocker.patch.object(distance_utils, "os")
    mock_os.environ = {}
