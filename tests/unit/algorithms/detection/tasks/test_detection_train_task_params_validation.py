...
class TestDetectionTrainTaskInputParamsValidation:
    @staticmethod
    def model():
    ...
    def test_train_task_train_input_params_validation(self):
        """
        <b>Description:</b>
        Check DetectionTrainTask object "train" method input parameters validation

        <b>Input data:</b>
        DetectionTrainTask object, "train" method unexpected-type input parameters
    ...
    def test_train_task_save_model_input_params_validation(self):
        """
        <b>Description:</b>
        Check DetectionTrainTask object "save_model" method input parameters validation

        <b>Input data:</b>
        DetectionTrainTask object, "model" non-ModelEntity object
