...
class TestOTXClsLitModule:
    ...
    def test_validation_step(
        ...
        batch_entity = [
            fxt_multiclass_cls_data_entity[1],
            fxt_multilabel_cls_data_entity[1],
            fxt_hlabel_cls_data_entity[1],
        ]
        pred_entity = [
            fxt_multiclass_cls_data_entity[2],
            fxt_multilabel_cls_data_entity[2],
            fxt_hlabel_cls_data_entity[2],
        ]
