...
for sample_type in eval_config:
    model_type = eval_config[sample_type]
    for model_name in model_type:
        ...
        for model in model_dict:
            ...
            alt_export = model_dict[model].get('subfolder') if not None else None
            param_list.append([model, test_id, sample_type, model_name, expected, alt_export])
