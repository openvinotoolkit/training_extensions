...
from otx.v2.adapters.torch.lightning.modules.models.encoders.sam_image_encoder import SAMImageEncoder
...
class TestSAMImageEncoder:
    ...
    def setup(self, mocker) -> None:
        self.mocker_backbone = mocker.patch(
            "otx.v2.adapters.torch.lightning.modules.models.encoders.sam_image_encoder.build_vit",
