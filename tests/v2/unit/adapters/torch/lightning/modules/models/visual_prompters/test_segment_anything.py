...
from otx.v2.adapters.torch.lightning.modules.models.visual_prompters.segment_anything import (
    SegmentAnything,
)
...
class TestSegmentAnything:
    ...
    def setup(self, monkeypatch) -> None:
        monkeypatch.setattr(
            "otx.v2.adapters.torch.lightning.modules.models.visual_prompters.segment_anything.SAMImageEncoder",
            MockImageEncoder,
        )
        monkeypatch.setattr(
            "otx.v2.adapters.torch.lightning.modules.models.visual_prompters.segment_anything.SAMPromptEncoder",
            MockPromptEncoder,
        )
        monkeypatch.setattr(
            "otx.v2.adapters.torch.lightning.modules.models.visual_prompters.segment_anything.SAMMaskDecoder",
            MockMaskDecoder,
        )
    ...
    def test_set_models(self, mocker, backbone: str) -> None:
        """Test set_models."""
        mocker.patch(
            "otx.v2.adapters.torch.lightning.modules.models.visual_prompters.segment_anything.SegmentAnything.freeze_networks"
        )
        mocker.patch(
            "otx.v2.adapters.torch.lightning.modules.models.visual_prompters.segment_anything.SegmentAnything.set_metrics"
        )
        mocker.patch(
            "otx.v2.adapters.torch.lightning.modules.models.visual_prompters.segment_anything.SegmentAnything.load_checkpoint"
        )
    ...
    def test_set_metrics(self, mocker, loss_type: str) -> None:
        """Test set_metrics."""
        mocker.patch(
            "otx.v2.adapters.torch.lightning.modules.models.visual_prompters.segment_anything.SegmentAnything.set_models"
        )
        mocker.patch(
            "otx.v2.adapters.torch.lightning.modules.models.visual_prompters.segment_anything.SegmentAnything.freeze_networks"
        )
    ...
    def test_load_checkpoint_with_url(self, mocker) -> None:
        ...
        mocker_load_state_dict = mocker.patch(
            "otx.v2.adapters.torch.lightning.modules.models.visual_prompters.segment_anything.SegmentAnything.load_state_dict"
        )
    ...
    def test_load_checkpoint_from_local_checkpoint(self, mocker, checkpoint: str) -> None:
        ...
        mocker.patch("otx.v2.adapters.torch.lightning.modules.models.visual_prompters.segment_anything.Path.open").__enter__.return_value = True
        mocker.patch("torch.load", return_value=OrderedDict())
        mocker_load_from_checkpoint = mocker.patch(
            "otx.v2.adapters.torch.lightning.modules.models.visual_prompters.segment_anything.SegmentAnything.load_from_checkpoint"
        )
        mocker_load_state_dict = mocker.patch(
            "otx.v2.adapters.torch.lightning.modules.models.visual_prompters.segment_anything.SegmentAnything.load_state_dict"
        )
    ...
    def test_training_step(self, mocker, loss_type: str, expected: Tensor) -> None:
        """Test training_step."""
        mocker.patch(
            "otx.v2.adapters.torch.lightning.modules.models.visual_prompters.segment_anything.SegmentAnything.forward",
            return_value=([torch.Tensor([[0, 1, 1, 0] for _ in range(4)])], [torch.tensor(1.0)]),
        )
        mocker.patch(
            "otx.v2.adapters.torch.lightning.modules.models.visual_prompters.segment_anything.SegmentAnything.postprocess_masks",
