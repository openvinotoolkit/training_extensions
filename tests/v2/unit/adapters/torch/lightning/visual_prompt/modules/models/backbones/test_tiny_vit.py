...
import torch
from otx.v2.adapters.torch.lightning.visual_prompt.modules.models.backbones.tiny_vit import (
    Attention,
    BasicLayer,
    Conv2dBN,
    ConvLayer,
...
def test_build_tiny_vit(mocker) -> None:
    ...
    mocker_vit = mocker.patch(
        "otx.v2.adapters.torch.lightning.visual_prompt.modules.models.backbones.tiny_vit.TinyViT"
    )
