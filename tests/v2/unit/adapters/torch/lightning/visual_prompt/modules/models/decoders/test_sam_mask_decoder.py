...
import pytest
import torch
from otx.v2.adapters.torch.lightning.visual_prompt.modules.models.decoders.sam_mask_decoder import (
    MLP,
    Attention,
    SAMMaskDecoder,
...
from otx.v2.adapters.torch.lightning.visual_prompt.modules.models.utils import (
    MLPBlock,
)
...
class TestTwoWayAttentionBlock:
    ...
    def test_forward(self, queries: torch.Tensor, keys: torch.Tensor, query_pe: torch.Tensor, key_pe: torch.Tensor) -> None:
        """Test forward."""
...
class TestAttention:
    ...
    def test_separate_heads(self, x: torch.Tensor, expected: tuple[int]) -> None:
    ...
    def test_recombine_heads(self, x: torch.Tensor, expected: tuple[int]) -> None:
    ...
    def test_forward(self, q: torch.Tensor, k: torch.Tensor, v: torch.Tensor, expected: tuple[int]) -> None:
        """Test forward."""
