...
import pytest
import torch
from otx.v2.adapters.torch.lightning.visual_prompt.modules.models.encoders.sam_prompt_encoder import (
...
class TestSAMPromptEncoder:
    ...
    def test_embed_points(self, points: torch.Tensor, labels: torch.Tensor, pad: bool, expected: tuple[int]) -> None:
        """Test _embed_points."""
    ...
    def test_embed_boxes(self, boxes: torch.Tensor, expected: tuple[int]) -> None:
        """Test _embed_boxes."""
    ...
    def test_embed_masks(self, mask: torch.Tensor, expected: tuple[int]) -> None:
        """Test _embed_masks."""
...
class TestPositionEmbeddingRandom:
    ...
    def test_pe_encoding(self) -> None:
        """Test _pe_encoding."""
        results = self.position_embedding_random.pe_encoding(torch.ones((2, 2, 2), dtype=torch.float32))
