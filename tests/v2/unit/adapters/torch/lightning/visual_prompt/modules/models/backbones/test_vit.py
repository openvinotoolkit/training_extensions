...
import pytest
import torch
from otx.v2.adapters.torch.lightning.visual_prompt.modules.models.backbones.vit import (
    Attention,
    Block,
    PatchEmbed,
    ViT,
...
def test_build_vit(mocker, backbone: str) -> None:
    """Test build_vit."""
    mocker_vit = mocker.patch("otx.v2.adapters.torch.lightning.visual_prompt.modules.models.backbones.vit.ViT")
