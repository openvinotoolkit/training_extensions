...
class CustomCascadeRCNN(SAMDetectorMixin, L2SPDetectorMixin, CascadeRCNN):
...
if is_mmdeploy_enabled():
    ...
    @FUNCTION_REWRITER.register_rewriter(
        "otx.algorithms.detection.adapters.mmdet.models.detectors.custom_cascade_maskrcnn.CustomCascadeRCNN.simple_test"
    )
    def custom_cascade_maskrcnn__simple_test(ctx, self, img, img_metas, proposals=None, **kwargs):
    ...
    @mark("custom_cascade_maskrcnn_forward", inputs=["input"], outputs=["dets", "labels", "masks", "feats", "saliencies"])
    ...
    @FUNCTION_REWRITER.register_rewriter(
        "otx.algorithms.detection.adapters.mmdet.models.detectors.custom_cascade_maskrcnn.CustomCascadeRCNN.forward"
    )
