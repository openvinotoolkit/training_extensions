...
class ShapeFactory:
    ...
    def shape_as_rectangle(shape: ShapeEntity) -> Rectangle:
        ...
        Example:
            ...
            >>> from otx.v2.api.entities.dataset_item import DatasetItem
            >>> from otx.v2.api.entities.image import NullImage
            >>> from otx.v2.api.entities.annotation_scene import NullAnnotationScene
