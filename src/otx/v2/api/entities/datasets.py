...
from otx.v2.api.entities.annotation import AnnotationSceneEntity, AnnotationSceneKind
...
class DatasetEntity(Generic[TDatasetItemEntity]):
    ...
    def with_empty_annotations(
        ...
        Refer to `otx.v2.api.entities.resultset.ResultSetEntity` for more info.
