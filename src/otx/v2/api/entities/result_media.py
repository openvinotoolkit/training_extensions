...
from otx.v2.api.entities.metadata import IMetadata
...
class ResultMediaEntity(IMetadata):
    ...
    `otx.v2.api.entities.annotation.AnnotationSceneEntity` and related to an optional
    `otx.v2.api.entities.label.LabelEntity`.
    ...
    Example:
        ...
        >>> from otx.v2.api.entities.scored_label import LabelSource, ScoredLabel
        >>> from otx.v2.api.entities.shapes.rectangle import Rectangle
