...
from otx.v2.adapters.torch.mmcv.mmdeploy.utils import is_mmdeploy_enabled
from otx.v2.adapters.torch.mmcv.modules.utils.task_adapt import map_class_names
...
if is_mmdeploy_enabled():
    ...
    from otx.v2.adapters.torch.mmcv.modules.hooks.recording_forward_hook import (  # pylint: disable=ungrouped-imports
        FeatureVectorHook,
        ReciproCAMHook,
    )

    @FUNCTION_REWRITER.register_rewriter(
        "otx.v2.adapters.torch.mmcv.mmcls.modules.models.classifiers.SAMImageClassifier.extract_feat"
    )
    ...
    @FUNCTION_REWRITER.register_rewriter(
        "otx.v2.adapters.torch.mmcv.mmcls.modules.models.classifiers.SAMImageClassifier.simple_test"
    )
