...
import torch
from mmcls.models import build_backbone, build_classifier, build_neck
...
def configure_in_channels(model_config, input_shape=[3, 224, 224]):
    # COPY from otx.algorithms.classification.adapters.mmcls.configurer.ClassificationConfigurer::configure_in_channel
