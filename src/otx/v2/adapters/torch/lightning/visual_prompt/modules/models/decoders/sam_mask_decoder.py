...
from otx.v2.adapters.torch.lightning.visual_prompt.modules.models.utils import LayerNorm2d, MLPBlock
...
class SAMMaskDecoder(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        """Initializes the SamMaskDecoder module.

        Args:
            transformer_dim (int): The dimension of the transformer.
            transformer_cfg (dict): The configuration dictionary for the TwoWayTransformer module.
            num_multimask_outputs (int, optional): The number of multimask outputs. Defaults to 3.
            activation (type[nn.Module], optional): The activation function to use. Defaults to nn.GELU.
            iou_head_depth (int, optional): The depth of the MLP for the IOU prediction head. Defaults to 3.
            iou_head_hidden_dim (int, optional): The hidden dimension of the MLP for the IOU prediction head.
                Defaults to 256.
        """
        super().__init__()
...
class MLP(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            sigmoid_output (bool, optional): Whether to apply sigmoid activation to the output. Defaults to False.
        """
        super().__init__()
...
class TwoWayTransformer(nn.Module):
    ...
    def __init__(
        ...
        """Initializes the SamMaskDecoder TwoWayTransformer module.

        Args:
            depth (int): The number of TwoWayAttentionBlock layers to use.
            ...
            activation (type[nn.Module], optional): The activation function to use. Defaults to nn.ReLU.
            attention_downsample_rate (int, optional): The downsample rate for the attention layers. Defaults to 2.
        """
        super().__init__()
        self.depth = depth
...
class TwoWayAttentionBlock(nn.Module):
    ...
    def __init__(
        ...
        """Initializes a SAMMaskDecoder TwoWayAttentionBlock module.

        Args:
            embedding_dim (int): The input embedding dimension.
            num_heads (int): The number of attention heads.
            mlp_dim (int, optional): The dimension of the intermediate MLP layer. Defaults to 2048.
            activation (type[nn.Module], optional): The activation function to use in the MLP layer.
                Defaults to nn.ReLU.
            attention_downsample_rate (int, optional): The downsample rate for the cross-attention layers.
                Defaults to 2.
            skip_first_layer_pe (bool, optional): Whether to skip the first layer of positional encoding.
                Defaults to False.
        """
        super().__init__()
...
class Attention(nn.Module):
    ...
    def __init__(
        ...
        """Initializes the SamMaskDecoder Attention module.

        Args:
            embedding_dim (int): The dimensionality of the input embeddings.
            num_heads (int): The number of attention heads to use.
            downsample_rate (int, optional): The rate at which to downsample the input embeddings. Defaults to 1.
        """
        super().__init__()
        self.embedding_dim = embedding_dim
