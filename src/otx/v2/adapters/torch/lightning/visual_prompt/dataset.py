"""OTX adapters.torch.lightning.visual_prompt.Dataset API."""
...
from otx.v2.adapters.torch.lightning.visual_prompt.modules.datasets import OTXVisualPromptingDataset
...
class VisualPromptDataset(LightningDataset):
    """A class representing a dataset for VisualPrompt tasks."""

    def __init__(
        self,
        task: TaskType | str | None = TaskType.VISUAL_PROMPTING,
        ...
        Args:
            task (Optional[Union[TaskType, str]]): The type of VISUAL_PROMPTING task to perform.
                Defaults to None.
    ...
    def build_dataloader(
        self,
        dataset: OTXVisualPromptingDataset | None,
        ...
        **kwargs,
        ...
        """Build a PyTorch DataLoader object from an OTXVisualPromptingDataset object.

        Args:
            dataset (OTXVisualPromptingDataset | None): The dataset to load.
