...
from otx.v2.adapters.torch.lightning.modules.models.utils import LayerNorm2d
...
class SAMPromptEncoder(nn.Module):
    ...
    def __init__(
        ...
        """Initializes the SamPromptEncoder module.

        Args:
            embed_dim (int): The embedding dimension.
            image_embedding_size (tuple[int, int]): The size of the image embedding.
            input_image_size (tuple[int, int]): The size of the input image.
            mask_in_chans (int): The number of channels in the mask.
...
class PositionEmbeddingRandom(nn.Module):
    ...
    def __init__(self, num_pos_feats: int = 64, scale: float | None = None) -> None:
        """Initializes a new instance of the `PositionEmbeddingRandom` class.

        Args:
            num_pos_feats (int): The number of positional encoding features to use.
            scale (float | None): The scaling factor for the Gaussian matrix used for positional encoding.
                If `None` or less than or equal to 0.0, a default value of 1.0 is used.
        """
        super().__init__()
    ...
    def pe_encoding(self, coords: Tensor) -> Tensor:
