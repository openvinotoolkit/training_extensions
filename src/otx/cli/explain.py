...
def otx_explain(overrides: list[str]) -> None:
    """Main entry point for XAI.
    ...
    with initialize(config_path="../config", version_base="1.3", job_name="otx_explain"):
