...
class Bottleneck(_Bottleneck):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.norm1_name, norm1 = build_norm_layer(self.norm_callable, width, postfix=1)
        self.norm2_name, norm2 = build_norm_layer(self.norm_callable, width, postfix=2)
        self.norm3_name, norm3 = build_norm_layer(self.norm_callable, self.planes * self.expansion, postfix=3)
