...
from otx.algo.instance_segmentation.mmdet.structures.bbox import HorizontalBoxes
...
class AnchorGenerator:
    ...
    def sparse_priors(
        ...
        priors = torch.stack([x, y, x, y], 1).to(dtype).to(device) + self.base_anchors[level_idx][base_anchor_id, :].to(
            device,
        )
