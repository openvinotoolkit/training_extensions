...
def foreground_zero_mean_normalize_image_data(data, channel_dim=4, background_value=0, tolerance=1e-5):
    # Normalise foreground data to zero mean
    # param data: Data is stored
    # param channel_dim: total channel dimension
    # param background_value: The piel value for background
    data = np.copy(data)
