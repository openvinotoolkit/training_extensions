...
def densenet_flops(input_shape, block_config, growth_rate,
                   k, init_features, verbose=1):
    ...
    for i in range(4):
        if verbose:
            print(
                f"At layer{i}, the value of channels:{c} and image:{out1},{out2}.")
