...
import examples.segmentation.utils.data as data_utils
import examples.segmentation.utils.loss_funcs as loss_funcs
...
def get_dataset(dataset_name: str) -> torch.utils.data.Dataset:
    ...
    if dataset_name.lower() == 'camvid':
        from examples.segmentation.datasets import CamVid as dataset
