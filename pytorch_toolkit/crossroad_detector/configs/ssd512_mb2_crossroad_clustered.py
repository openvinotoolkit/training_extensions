...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='dataset/annotation_example_train.pkl',
        img_prefix='dataset',
        img_scale=(512, 512),
    ...
    val=dict(
        type=dataset_type,
        ann_file='dataset/annotation_example_val.pkl',
        img_prefix='dataset',
        img_scale=(512, 512),
        img_norm_cfg=img_norm_cfg,
        size_divisor=32,
...
log_level = 'INFO'
work_dir = 'ssd512_mb2_crossroad_clustered'
load_from = 'checkpoint/epoch_21.pth'
resume_from = None
workflow = [('train', 1)]
