...
model = dict(
    ...
    bbox_head=dict(
        ...
        anchor_generator=dict(
            ...
            strides=(16, 32),
            widths=[
		 [image_width * x for x in [0.030319100851883052, 0.06983469562113481, 0.0896789415692108, 0.2483828203507245]],
                 [image_width * x for x in [0.16599406375283482, 0.22625136235966045, 0.5378538906986432, 0.42348993106325517, 0.8319818652057693]],
	    ],
            heights=[
		 [image_height * x for x in [0.05278004605817635, 0.13254872810382887, 0.2676618623745634, 0.21563111510925026]],
                 [image_height * x for x in [0.439776191190808, 0.6682003099037013, 0.47115695974153415, 0.8533047297744046, 0.8352805754271161]],
	    ],
        ),
        bbox_coder=dict(
...
log_level = 'INFO'
work_dir = '/media/cluster_fs/user/ikrylov/experiments/vehicle_person_bike_detection/0201/outputs'
load_from = None
resume_from = None
workflow = [('train', 1)]
