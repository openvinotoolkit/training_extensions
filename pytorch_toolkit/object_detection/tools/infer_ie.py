...
def build_argparser():
    ...
    parser.add_argument("--cpu_extension", type=str, default=None,
...
def draw(image, detections, conf_threshold=0.25, bbox_color=(50, 255, 50)):
    ...
    for obj in detections:
        ...
        if score > conf_threshold:
            ...
            label = "{0}: {1:.2f}".format(class_id, score)
...
def main():
    ...
    exec_net, _, input_blob, out_blob, shape = load_ir_model(args.model, args.device,
