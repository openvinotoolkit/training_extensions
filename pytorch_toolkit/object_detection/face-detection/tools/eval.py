...
def eval(config_path, snapshot, compute_wider_metrics, wider_dir, out):
...
def main():
    args = parse_args()
    eval(args.config, args.snapshot, args.compute_wider_metrics, args.wider_dir, args.out)
