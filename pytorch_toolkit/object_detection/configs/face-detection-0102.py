...
model = dict(
    ...
    bbox_head=dict(
        ...
        anchor_widths=( [ 9.4 * 1.28, 25.1 * 1.28, 14.7 * 1.28, 34.7 * 1.28], [143.0 * 1.28,  77.4 * 1.28, 128.8 * 1.28,  51.1 * 1.28, 75.6 * 1.28]),
        anchor_heights=([15.0 * 1.28, 39.6 * 1.28, 25.5 * 1.28, 63.2 * 1.28], [227.5 * 1.28, 162.9 * 1.28, 124.5 * 1.28, 105.1 * 1.28, 72.6 * 1.28]),
