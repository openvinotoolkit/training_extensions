...
| vehicle-detection-0005 | 212.22 | 36.56 | 47.6 | [snapshot](https://download.01.org/opencv/openvino_training_extensions/models/object_detection/v2/vehicle-detection-0205.pth), [configuration file](./vehicle-detection-0205/config.py) | 4 |
