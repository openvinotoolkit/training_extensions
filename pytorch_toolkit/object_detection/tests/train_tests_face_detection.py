...
class FaceDetection0200TestCaseOteApi(unittest.TestCase):
    ...
    def test_ok(self):
        self.model_name = 'face-detection-0200'

        self.template_file = f'./face-detection/{self.model_name}/template.yml'
        self.ann_file = '../../../../data/airport/annotation_faces_train.json'
        self.img_root = '../../../../data/airport/'
        self.ote_url = 'https://download.01.org/opencv/openvino_training_extensions'
