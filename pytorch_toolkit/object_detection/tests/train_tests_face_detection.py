...
class FaceDetection0200TestCase(create_test_case(
    'face-detection',
    'face-detection-0200',
...
class FaceDetection0202TestCase(create_test_case(
    'face-detection',
    'face-detection-0202',
    '../../../../../data/airport/annotation_faces_train.json',
    '../../../../../data/airport/'
...
class FaceDetection0204TestCase(create_test_case(
    'face-detection',
    'face-detection-0204',
    '../../../../../data/airport/annotation_faces_train.json',
    '../../../../../data/airport/'
...
class FaceDetection0205TestCase(create_test_case(
    'face-detection',
    'face-detection-0205',
    '../../../../../data/airport/annotation_faces_train.json',
    '../../../../../data/airport/'
...
class FaceDetection0206TestCase(create_test_case(
    'face-detection',
    'face-detection-0206',
    '../../../../../data/airport/annotation_faces_train.json',
    '../../../../../data/airport/'
...
class FaceDetection0207TestCase(create_test_case(
    'face-detection',
    'face-detection-0207',
    '../../../../../data/airport/annotation_faces_train.json',
    '../../../../../data/airport/'
