...
class PersonDetection0200TestCaseOteApi(unittest.TestCase):
    ...
    def test_ok(self):
        self.model_name = 'person-detection-0200'

        self.template_file = f'./person-detection/{self.model_name}/template.yml'
        self.ann_file = '../../../../data/airport/annotation_person_val.json'
        self.img_root = '../../../../data/airport/val'
        self.ote_url = 'https://download.01.org/opencv/openvino_training_extensions'
