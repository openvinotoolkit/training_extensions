...
class PersonVehicleBikeDetection2000TestCase(create_test_case(
...
class PersonVehicleBikeDetection2001TestCase(create_test_case(
    'person-vehicle-bike-detection',
...
class PersonVehicleBikeDetection2002TestCase(create_test_case(
    'person-vehicle-bike-detection',
