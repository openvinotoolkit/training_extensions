...
def convert_to_wider(config, input_file, out_folder, update_config):
    """ Main function. """

    if input_file is not None and not input_file.endswith(('.pkl', '.pickle')):
