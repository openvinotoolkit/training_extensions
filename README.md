...
[Installation](https://openvinotoolkit.github.io/training_extensions/1.3.0/guide/get_started/installation.html) •
[Documentation](https://openvinotoolkit.github.io/training_extensions/1.3.0/index.html) •
[License](#license)
...
OpenVINO™ Training Extensions supports the [following learning methods](https://openvinotoolkit.github.io/training_extensions/1.3.0/guide/explanation/algorithms/index.html):
...
- Integrated, efficient [hyper-parameter optimization module (HPO)](https://openvinotoolkit.github.io/training_extensions/1.3.0/guide/explanation/additional_features/hpo.html). Through dataset proxy and built-in hyper-parameter optimizer, you can get much faster hyper-parameter optimization compared to other off-the-shelf tools. The hyperparameter optimization is dynamically scheduled based on your resource budget.
...
Please refer to the [installation guide](https://openvinotoolkit.github.io/training_extensions/1.3.0/guide/get_started/installation.html) for installing it using Python venv (virtual environment), or use the following steps to run it in a containerised environment:
...
You can find more details with examples in the [CLI command intro](https://openvinotoolkit.github.io/training_extensions/1.3.0/guide/get_started/cli_commands.html).
