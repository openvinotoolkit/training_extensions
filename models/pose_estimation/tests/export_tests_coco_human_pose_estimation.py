...
from common.pose_estimation_test_case import create_pose_estimation_export_test_case
...
class HumanPoseEstimation0005TestCase(
        create_pose_estimation_export_test_case(
            model_name='human-pose-estimation-0005',
            **kwargs
        )
):
    """ Test case for human-pose-estimation-0005 model export. """
