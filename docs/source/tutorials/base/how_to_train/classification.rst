...
On this page we show how to train, validate, export and optimize :ref:`MobileNet-V3-large-1x <classificaiton_models>` model on the `flowers dataset <https://www.tensorflow.org/hub/tutorials/image_feature_vector#the_flowers_dataset>` from TensorFlow.
