...
class CommonMethods:
    ...
    @staticmethod
    def compare_images(image_actual, expected_image, message) -> None:
        """Function to compare images arrays"""
        try:
            assert (image_actual == expected_image).all()
...
class TestHelpers:
    ...
    def test_helpers_draw_transparent_rectangle(self):
        ...
        message = "Unexpected image generated by 'draw_transparent_rectangle' method for rectangle inscribed to image"
        CommonMethods.compare_images(image, expected_image, message)
        ...
        helpers.draw_transparent_rectangle(image, x1, y1, x2, y2, color, alpha)
        message = "Unexpected image generated by 'draw_transparent_rectangle' method for rectangle equal to image shape"
        CommonMethods.compare_images(image, expected_image, message)
        ...
        helpers.draw_transparent_rectangle(image, x1, y1, x2, y2, color, alpha)
        message = "Unexpected image generated by 'draw_transparent_rectangle' method for rectangle out-of-bounds image"
        CommonMethods.compare_images(image, expected_image, message)
    ...
    def test_helpers_generate_draw_command_for_text(self):
        ...
        for text_color, expected_text_color in [
            ...
            CommonMethods.compare_images(actual_image, expected_image, message)
    ...
    def test_helpers_generate_draw_command_for_label(self):
        ...
        for show_labels in [True, False]:
            for show_confidence in [True, False]:
                ...
                assert draw_command[2] == expected_height
                actual_image = draw_command[0](image)
                message = "Unexpected image generated by 'generate_draw_command_for_label' method"
                CommonMethods.compare_images(actual_image, expected_image, message)
    ...
    def test_helpers_draw_flagpole(self):
        ...
        message = "Unexpected image generated by 'draw_flagpole' method for line that fits image borders"
        CommonMethods.compare_images(actual_image, expected_image, message)
        ...
        message = "Unexpected image generated by 'draw_flagpole' method for line that matches image borders"
        CommonMethods.compare_images(actual_image, expected_image, message)
        ...
        message = "Unexpected image generated by 'draw_flagpole' method for line that out of image borders"
        CommonMethods.compare_images(actual_image, expected_image, message)
...
class TestShapeDrawer:
    ...
    def test_shape_drawer_draw(self):
        ...
        for show_count, is_one_label in [
            ...
            message = (
                f"Unexpected image generated by 'draw' method of ShapeDrawer class for 'show_count' is {show_count} and"
                f"'is_one_label' is {is_one_label}"
            )
            CommonMethods.compare_images(actual_image, expected_image, message)
...
class TestTopLeftDrawer:
    ...
    def test_top_left_drawer_draw_labels(self):
        ...
        for show_count, is_one_label in [(False, True), (True, True), (False, False)]:
            ...
            message = (
                f"Unexpected image generated by 'draw_labels' method of TopLeftDrawer subclass for 'show_count': "
                f"{show_count} and 'is_one_label': {is_one_label}"
            )
            CommonMethods.compare_images(actual_image, expected_image, message)
            assert (
    ...
    def test_top_left_drawer_draw(self):
        ...
        message = (
            "Unexpected image generated by 'draw' method of TopLeftDrawer subclass"
        )
        CommonMethods.compare_images(actual_image, expected_image, message)
    ...
    def test_top_left_drawer_draw_annotation_count(self):
        ...
        message = "Unexpected image generated by 'generate_draw_annotation_count' method of TopLeftDrawer subclass"
        CommonMethods.compare_images(actual_image, expected_image, message)
        assert (
            shape_drawer.top_left_drawer.cursor_pos
            == expected_shape_drawer.top_left_drawer.cursor_pos
...
class TestRectangleDrawer:
    ...
    def test_rectangle_drawer_draw(self):
        ...
        for rectangle, expected_cursor_position, position in [
            ...
            message = f"Unexpected image generated by 'draw' method of RectangleDrawer subclass {position}"
            CommonMethods.compare_images(actual_image, expected_image, message)
            assert (
                shape_drawer.top_left_drawer.cursor_pos
                == expected_shape_drawer.top_left_drawer.cursor_pos
