...
args = {
    "--train-ann-file": "data/anomaly/Hazelnut_Toy/classification/train.json",
    "--train-data-roots": "data/anomaly/Hazelnut_Toy/hazelnut",
    "--val-ann-file": "data/anomaly/Hazelnut_Toy/classification/val.json",
    "--val-data-roots": "data/anomaly/Hazelnut_Toy/hazelnut",
    "--test-ann-files": "data/anomaly/Hazelnut_Toy/classification/test.json",
