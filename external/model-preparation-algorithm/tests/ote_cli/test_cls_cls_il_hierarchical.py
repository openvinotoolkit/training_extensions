...
# SL w/ 'intel', 'openvino' (multi-class) | 'car, tree' (multi-label)
args0 = {
    '--train-ann-file': 'data/classification/hierarchical/hierarchical_initial.json',
    '--train-data-roots': 'data/classification/images',
    '--val-ann-file': 'data/classification/hierarchical/hierarchical_initial.json',
    '--val-data-roots': 'data/classification/images',
    '--test-ann-files': 'data/classification/hierarchical/hierarchical_initial.json',
    '--test-data-roots': 'data/classification/images',
    '--input': 'data/classification/images',
    'train_params': [
        'params',
...
# C-IL w/ 'intel', 'openvino', 'opencv' (multi-class) | 'car, tree, bug' (multi-label) classes
args = {
    '--train-ann-file': 'data/classification/hierarchical/hierarchical_IL.json',
    '--train-data-roots': 'data/classification/images',
    '--val-ann-file': 'data/classification/hierarchical/hierarchical_IL.json',
    '--val-data-roots': 'data/classification/images',
    '--test-ann-files': 'data/classification/hierarchical/hierarchical_IL.json',
    '--test-data-roots': 'data/classification/images',
    '--input': 'data/classification/images',
    'train_params': [
        'params',
