...
func Handle(eps endpoint.Endpoints, conn *rabbitmq.Connection, msg amqp.Delivery) {
...
type RequestData = service.BuildFindRequestData
...
type ResponseData = types.BuildFindResponse
