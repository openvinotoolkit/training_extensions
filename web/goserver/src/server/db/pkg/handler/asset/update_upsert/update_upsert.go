...
var (
	Request = n.RDBAssetUpdateUpsert
	Queue   = n.QDatabase
)
...
func decodeRequest(_ context.Context, deliv *amqp.Delivery) (interface{}, error) {
	...
	if err != nil {
		log.Println("asset.update_upsert.decodeRequest.Unmarshal", err)
	}
	return req.Data, err
}
